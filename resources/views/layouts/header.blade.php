        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" >Jams@company.com</a>
...
<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color:">
    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <a class="navbar-brand text-success logo h1 align-self-center" href="{{ route('index') }}">
            <img src="{{ asset('assets/front/img/jams.jpg') }}" alt="logo" class="img-fluid" style="max-height: 50px; margin-top: -5px;">
            Jams
        </a>
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
            <div class="flex-fill">
                <ul class="nav navbar-nav d-flex mx-lg-auto">
                    ...
                    <li class="nav-item me-3">
                        <a class="nav-link" href="{{ route('seccion1') }}">Hombre</a>
                    </li>
                    <li class="nav-item me-3">
                        <a class="nav-link" href="{{ route('seccion2') }}">Mujer</a>
                    </li>
                    <li class="nav-item me-3">
                        <a class="nav-link" href="{{ route('seccion3') }}">Niños</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('seccion4') }}">Unisex</a>
                    </li>
                </ul>
            </div>
            <div class="navbar align-self-center d-flex">
               ...
               @include('aplicacion/components.usuario')
            </div>
        </div>
